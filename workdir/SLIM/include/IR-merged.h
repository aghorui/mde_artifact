...
class IR {
  ...
  public:
    ~IR();
    const std::vector<llvm::Function *> &getFunctions() const;
    ...
    /**
     * Get the corresponding SLIM instruction
     */
    BaseInstruction *getSLIMInstruction(llvm::Instruction &instruction);
    /**
     * @deprecated Use `getSLIMInstruction` instead.
     */
    BaseInstruction *
    convertLLVMToSLIMInstruction(llvm::Instruction &instruction);
